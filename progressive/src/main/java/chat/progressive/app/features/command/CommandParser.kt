    ...
    fun parseSlashCommand(textMessage: CharSequence, formattedMessage: String?, isInThreadTimeline: Boolean): ParsedCommand {
        ...
        return if (!message.startsWith("/")) {
            ...
            when {
                ...
                Command.LENNY.matches || Command.TABLEFLIP.matches || Command.UNFLIP.matches || Command.ECHO.matches || Command.COIN.matches || Command.ROLL.matches || Command.EIGHTBALL.matches || Command.EMOJI.matches || Command.REACT.matches || Command.NICK.matches || Command.MYROOMNICK.matches || Command.TOPIC.matches || Command.INVITE.matches || Command.JOIN.matches || Command.LEAVE.matches || Command.BAN.matches || Command.UNBAN.matches || Command.IGNORE.matches || Command.UNIGNORE.matches || Command.WHOIS.matches(slashCommand) -> {
                ...
                Command.LLM.matches(slashCommand) || Command.LLMP.matches(slashCommand) ||
                        ...
                        Command.HIDE_EMOJI.matches(slashCommand) || Command.SMSAGENT.matches(slashCommand) || Command.SCHEDULE.matches(slashCommand) || Command.TRANSLATE.matches(slashCommand) || Command.WEATHER.matches(slashCommand) || Command.REMIND.matches(slashCommand) || Command.STATS.matches || Command.SHRUG.matches || Command.LENNY.matches || Command.TABLEFLIP.matches || Command.UNFLIP.matches || Command.ECHO.matches || Command.COIN.matches || Command.ROLL.matches || Command.EIGHTBALL.matches || Command.EMOJI.matches || Command.REACT.matches || Command.NICK.matches || Command.MYROOMNICK.matches || Command.TOPIC.matches || Command.INVITE.matches || Command.JOIN.matches || Command.LEAVE.matches || Command.BAN.matches || Command.UNBAN.matches || Command.IGNORE.matches || Command.UNIGNORE.matches || Command.WHOIS.matches(slashCommand) || Command.PIN.matches(slashCommand) || Command.UNPIN.matches(slashCommand) || Command.MENTION.matches(slashCommand) -> {
                    val cmd = listOf(Command.LLM, Command.LLMP, Command.AGENT, Command.WEB, Command.HIDE_EMOJI, Command.SMSAGENT, Command.SCHEDULE, Command.TRANSLATE, Command.WEATHER, Command.REMIND, Command.STATS, Command.SHRUG, Command.LENNY, Command.TABLEFLIP, Command.UNFLIP, Command.ECHO, Command.COIN, Command.EMOJI, Command.REACT, Command.NICK, Command.MYROOMNICK, Command.TOPIC, Command.INVITE, Command.JOIN, Command.LEAVE, Command.BAN, Command.UNBAN, Command.IGNORE, Command.UNIGNORE, Command.WHOIS, Command.ROLL, Command.EIGHTBALL, Command.PIN, Command.UNPIN, Command.MENTION)
