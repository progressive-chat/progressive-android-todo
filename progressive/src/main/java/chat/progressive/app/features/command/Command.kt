...
enum class Command(
    ...
    TABLEFLIP("/tableflip", null, "<message>", CommonStrings.command_description_weather, false, true),
    UNFLIP("/unflip", null, "<message>", CommonStrings.command_description_weather, false, true),
    COIN("/coin", null, "", CommonStrings.command_description_weather, false, true),
    ROLL("/roll", null, "[N]d[S]", CommonStrings.command_description_weather, false, true),
    EMOJI("/emoji", arrayOf("/e"), "<name>", CommonStrings.command_description_weather, false, true),
    NICK("/nick", null, "<displayName>", CommonStrings.command_description_weather, false, true),
    TOPIC("/topic", null, "<topic>", CommonStrings.command_description_weather, false, true),
    INVITE("/invite", null, "<userId>", CommonStrings.command_description_weather, false, true),
    LEAVE("/leave", null, "", CommonStrings.command_description_weather, false, true),
    BAN("/ban", null, "<userId>", CommonStrings.command_description_weather, false, true),
    IGNORE("/ignore", null, "<userId>", CommonStrings.command_description_weather, false, true),
    UNIGNORE("/unignore", null, "<userId>", CommonStrings.command_description_weather, false, true),
    MOTIVATE("/motivate",null,"",CommonStrings.command_description_weather,false,true),
    QUOTE("/quote",null,"",CommonStrings.command_description_weather,false,true),
    FORTUNE("/fortune",null,"",CommonStrings.command_description_weather,false,true),
    WHOIS("/whois", null, "<userId>", CommonStrings.command_description_weather, false, true),
    UNBAN("/unban", null, "<userId>", CommonStrings.command_description_weather, false, true),
    JOIN("/join", null, "<roomId-or-alias>", CommonStrings.command_description_weather, false, true),
    MYROOMNICK("/myroomnick", null, "<name>", CommonStrings.command_description_weather, false, true),
    REACT("/react", null, "<emoji>", CommonStrings.command_description_weather, false, true),
    EIGHTBALL("/8ball", null, "<question>", CommonStrings.command_description_weather, false, true),
    ECHO("/echo", null, "<message>", CommonStrings.command_description_weather, false, true),
