...
class TimelineViewModel @AssistedInject constructor(
    ...
    private fun observeSummaryState() {
        ...
        onAsync(RoomDetailViewState::asyncRoomSummary) { summary ->
            val todoKeyword = progressivePreferences.getTodoKeyword().lowercase()
            setState {
                ...
                copy(
                        ...
                        isTodoRoom = progressivePreferences.isTodoRoomsEnabled() && summary.topic.lowercase().contains(todoKeyword)
                )
            }
